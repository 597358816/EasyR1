...
MODEL_PATH=/home/dataset-assist-0/wc/models/Qwen/Qwen3-4B  # replace it with your local file path
NAME="qwen3-4b-DAPO"
...
python3 -m verl.trainer.main \
    ...
    trainer.save_checkpoint_path="/home/dataset-assist-0/wc/checkpoints/Qwen3-4B/${NAME}" \
    trainer.load_checkpoint_path=/home/dataset-assist-0/wc/checkpoints/Qwen3-4B/${NAME}/global_step_70 \
