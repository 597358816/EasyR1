...
MODEL_PATH=/vepfs-mlp2/c20250203/250602012/models/Qwen/Qwen2.5-math-7B  # replace it with your local file path
NAME="qwen-math-7b-AEPO-ab-temp-ratio" 

CHECKPOINT_ROOT="/vepfs-mlp2/c20250203/250602012/checkpoints/Qwen2.5-math-7B/${NAME}"
...
/vepfs-mlp2/c20250203/250602012/Anaconda/envs/easyr1/bin/python -m verl.trainer.main \
    ...
    trainer.save_checkpoint_path="/vepfs-mlp2/c20250203/250602012/checkpoints/Qwen2.5-math-7B/${NAME}" \
    trainer.total_episodes=10 \
    trainer.n_gpus_per_node=8 \
    trainer.val_before_train=false \
    trainer.algorithm="AEPO-ab" \
    "${LOAD_CHECKPOINT_ARGS[@]}"
