...
MODEL_PATH=/home/dataset-local/models/Qwen/Qwen2.5-7B  # replace it with your local file path
NAME="qwen2.5-7b-GRPO-2048"
...
python3 -m verl.trainer.main \
    ...
    trainer.save_checkpoint_path="/home/dataset-local/checkpoints/Qwen2.5-7B/${NAME}" \
